...
var dwCharSet uint32 = DEFAULT_CHARSET
...
func OnInputLangChange(hwnd HWND, msg uint32, wParam, lParam uintptr) (result uintptr){
    ...
    return OnDisplayChange(hwnd, msg, wParam, lParam)
}
...
func main() {
    ...
    initWindow("KeyView2", "Keyboard Message Viewer #2", syscall.NewCallback(WndProc))
}
